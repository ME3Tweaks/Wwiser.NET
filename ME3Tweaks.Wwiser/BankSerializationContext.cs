...
/// <summary>
/// Common contextual data that is needed for serialization, deserialization, and conversion
/// </summary>
...
{
    public static BankSerializationContext FromBank(WwiseBank bank)
    {
        return new BankSerializationContext(bank.BKHD.BankGeneratorVersion, false, bank.BKHD.FeedbackInBank);
    }
}